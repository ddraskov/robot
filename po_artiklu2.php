   ...
   <body class="tm-background">
        ...
        <div class="tm-middle">
	      ...
	      <article class="uk-article">
                            ...
                            <h1 class="uk-article-title">Ra�uni s odabranim artiklom u razdoblju</h1>


                            <p class="uk-article-lead">
							Prona�i sve ra�une u odabranom razdoblju gdje se pojavljuje zadani artikal.
							</p>
	  ...
	  <form  class="uk-form" method="post" action="po_artiklu2.php">
			 ...
			 <input data-uk-tooltip title="Odaberi datum po�etka" type="text" placeholder="od datuma" uk-icon-calendar data-uk-datepicker="{format:'YYYY-MM-DD'}" name="DATUM_OD">
			 <input data-uk-tooltip title="Odaberi datum kraja" type="text" placeholder="do datuma" data-uk-datepicker="{format:'YYYY-MM-DD'}" name="DATUM_DO">
			  <input data-uk-tooltip title="Odaberi �ifru artikla" type="text" placeholder="�ifra artikla" id="SIFRA_ARTIKLA" name="SIFRA_ARTIKLA" />
...
echo "</thead>";
  ...
  while(odbc_fetch_row($result))
  {
    ...
    echo "<tr>";
	 ...
	 // ------------------------------------------------------------------------OVDJE IDE MODALNI POGLED na RA�UN ---------------------------------
...
$upit_stavke_rac = "USE POSB0405
					SELECT     dbo.ARTIKAL.SIFRA_ARTIKLA AS �ifra, dbo.ARTIKAL.NAZIV_ARTIKLA AS Naziv, dbo.STAVKA_MP.KOLICINA_IZLAZ AS Koli�ina,
                      dbo.STAVKA_MP.VRIJEDNOST_SA_PDV AS Cijena, dbo.STAVKA_MP.SKLAD_ISPORUKE AS [Skladi�te isporuke]
