   ...
   <body class="tm-background">
        ...
        <div class="tm-middle">
	      ...
	      <article class="uk-article">
                            ...
                            <h1 class="uk-article-title">Rekpitulacija maloprodajnih računa</h1>
	  ...
	  <form  class="uk-form" method="post" action="rekapitulacija_mal.php">
			...
			<select name="TRGOVINA">
                        <option>TTTS-2101</option>
             			<option>SPLIT 3</option>
						<option>GRAD</option>
						<option>OMIŠ</option>
						<option>IMOTSKI</option>
						<option>SINJ</option>
						<option>SOLIN</option>
...
switch ($artikal) {
    case "TTTS-2101":
			$query = "USE POSB0405 SELECT CONVERT(VARCHAR(20),dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA,104)+ '   ' + CONVERT(VARCHAR(8), dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA,108) as datum, dbo.DOKUMENT_POS_MP.BROJ_POS_MP_RACUNA, dbo.DOKUMENT_POS_MP.BROJ_ZAKLJUCKA_DANA, CONVERT (decimal(15 , 2),dbo.DOKUMENT_POS_MP.IZNOS_POS_MP_RACUNA) AS Iznos
						FROM  dbo.DOKUMENT_POS_MP
			WHERE ((dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA >= '$odd' AND dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA <= '$doo') AND (dbo.DOKUMENT_POS_MP.SIFRA_KASE = '101' OR dbo.DOKUMENT_POS_MP.SIFRA_KASE = '102')) 
    ...
    case "SPLIT 3":
			$query = "USE POSB0405 SELECT CONVERT(VARCHAR(20),dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA,104)+ '   ' + CONVERT(VARCHAR(8), dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA,108) as datum, dbo.DOKUMENT_POS_MP.BROJ_POS_MP_RACUNA, dbo.DOKUMENT_POS_MP.BROJ_ZAKLJUCKA_DANA, CONVERT (decimal(15 , 2),dbo.DOKUMENT_POS_MP.IZNOS_POS_MP_RACUNA) AS Iznos
						FROM  dbo.DOKUMENT_POS_MP
			WHERE ((dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA >= '$odd' AND dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA <= '$doo') AND (dbo.DOKUMENT_POS_MP.SIFRA_KASE = '201' OR dbo.DOKUMENT_POS_MP.SIFRA_KASE = '202' OR dbo.DOKUMENT_POS_MP.SIFRA_KASE = '203' OR dbo.DOKUMENT_POS_MP.SIFRA_KASE = '204' OR dbo.DOKUMENT_POS_MP.SIFRA_KASE = '205' OR dbo.DOKUMENT_POS_MP.SIFRA_KASE = '206' OR dbo.DOKUMENT_POS_MP.SIFRA_KASE = '207')) 
			ORDER BY dbo.DOKUMENT_POS_MP.BROJ_POS_MP_RACUNA";
        ...
        $query = "USE POSB0405 SELECT CONVERT(VARCHAR(20),dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA,104)+ '   ' + CONVERT(VARCHAR(8), dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA,108) as datum, dbo.DOKUMENT_POS_MP.BROJ_POS_MP_RACUNA, dbo.DOKUMENT_POS_MP.BROJ_ZAKLJUCKA_DANA, CONVERT (decimal(15 , 2),dbo.DOKUMENT_POS_MP.IZNOS_POS_MP_RACUNA) AS Iznos
						FROM  dbo.DOKUMENT_POS_MP
			WHERE ((dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA >= '$odd' AND dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA <= '$doo') AND (dbo.DOKUMENT_POS_MP.SIFRA_KASE = '301' OR dbo.DOKUMENT_POS_MP.SIFRA_KASE = '302'))
			ORDER BY dbo.DOKUMENT_POS_MP.BROJ_POS_MP_RACUNA";
        break;
		case "OMIŠ":
        $query = "USE POSB0405 SELECT CONVERT(VARCHAR(20),dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA,104)+ '   ' + CONVERT(VARCHAR(8), dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA,108) as datum, dbo.DOKUMENT_POS_MP.BROJ_POS_MP_RACUNA, dbo.DOKUMENT_POS_MP.BROJ_ZAKLJUCKA_DANA, CONVERT (decimal(15 , 2),dbo.DOKUMENT_POS_MP.IZNOS_POS_MP_RACUNA) AS Iznos
						FROM  dbo.DOKUMENT_POS_MP
			WHERE ((dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA >= '$odd' AND dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA <= '$doo') AND (dbo.DOKUMENT_POS_MP.SIFRA_KASE = '401'))
			ORDER BY dbo.DOKUMENT_POS_MP.BROJ_POS_MP_RACUNA";
        break;
		case "SOLIN":
        $query = "USE POSB0405 SELECT CONVERT(VARCHAR(20),dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA,104)+ '   ' + CONVERT(VARCHAR(8), dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA,108) as datum, dbo.DOKUMENT_POS_MP.BROJ_POS_MP_RACUNA, dbo.DOKUMENT_POS_MP.BROJ_ZAKLJUCKA_DANA, CONVERT (decimal(15 , 2),dbo.DOKUMENT_POS_MP.IZNOS_POS_MP_RACUNA) AS Iznos
						FROM  dbo.DOKUMENT_POS_MP
			WHERE ((dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA >= '$odd' AND dbo.DOKUMENT_POS_MP.DATUM_DOKUMENTA <= '$doo') AND (dbo.DOKUMENT_POS_MP.SIFRA_KASE = '251'))
			ORDER BY dbo.DOKUMENT_POS_MP.BROJ_POS_MP_RACUNA";
        break;
}
  ...
  echo "<h2>Rekapitulacija maloprodajnih računa za ".$artikal." od ".$od_dan.".".$od_mj.".".$od_god."    do   ".$do_dan.".".$do_mj.".".$do_god."</h2>";
 echo "</div>";
 echo "</div>";
