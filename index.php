...
//--> 
 ...
 ?>
      ...
      <form  class="uk-form" method="post" action="index.php">
             ...
             <input data-uk-tooltip title="Odaberi šifru artikla.Pretraživnje po slovu šifre" type="text" placeholder="Šifra artikla" id="SIFRA_ARTIKLA" name="SIFRA_ARTIKLA" />
...
<div class="uk-panel uk-panel-box uk-panel-box-primary">
	...
	echo "<a href=\"http://www.robot.hr/pretrazi/?term=.$link\" target=\"_blank\">"."Pretraži na www.robot.hr"."</a>";
	echo $barcod['BARKOD'];
